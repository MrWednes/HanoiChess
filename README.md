...
3.棋子有大小之分，五个等级从小到大分别为1，2，3，4，5 v
4.白方拥有白色棋子，黑方拥有黑色棋子 <br>
5.开始阶段黑色棋子和白色棋子分别大到小叠成一摞，分别置于棋盘的左上角和右下角，如下图 <br>
游戏目标：将己方的五枚棋子早于对方移入对方的棋子起始处，棋子移入该位置时会从棋盘上消失  <br>
 
**棋子移动规则：**<br>
1.玩家双方轮流行棋，只可移动己方棋子，每次行棋只可移动一枚棋子一步，一步为棋子所在网格交点所在方格的任意一个处自身所在交点的任意一个交点 <br>
2.较小的棋子可以放置到较大的棋子上方，这时下方棋子不可移动，较大棋子不可放置到较小棋子上 <br>
3.当对方较小棋子防止到我方较大棋子上时，我方可用与对方相同大小的棋子，与对方的棋子调换位置 <br>
